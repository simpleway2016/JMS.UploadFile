...
export class JMSUploadFile {
    ...
    onError: (sender: JMSUploadFile, err) => void;
     ...
     */
    constructor(fileEle: any, routeName: string , serverUrl: string = undefined) {
        ...
        this.webSocket.onmessage = (ev) => {
            ...
            if (!this.sendedFirstMesssage) {
                ...
                if (this.serverReceived == -1) {
                    ...
                    var mytranId = this.tranId;
                    this.tranId = "";
                    if (this.onCompleted != null) {
                        this.onCompleted(this, mytranId);
                    }
                }
            }
        };
...
class FileProvider implements IDataProvider {
    obj: File;
    name: string;
    size: number;
    reader: FileReader;
